      ...
      <div className="shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] max-w-6xl rounded-md p-6">
        ...
        <div className="grid md:grid-cols-2 items-center gap-8">
          ...
          <form className="max-w-md w-full mx-auto">
            <div className="mb-12">
              <h3 className="text-4xl font-extrabold text-blue-600">Welcome,Register Here...</h3>
            </div>
            <div>
              <div className="relative flex items-center">
                <input name="text" type="text" required className="w-full text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter your Name" />
              </div>
            </div>
            <div> <br />
              <div className="relative flex items-center">
            ...
            <div className="mt-12">
              ...
              <p className="text-sm text-center mt-8"> Already have an account <a href="javascript:void(0);" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Login here</a></p>
            </div>
          </form>
        </div>
      </div>
