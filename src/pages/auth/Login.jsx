        ...
        <div className="grid md:grid-cols-2 items-center gap-8">
          ...
          <form className="max-w-md w-full mx-auto">
            ...
            <div className="mt-12">
              ...
              <p className="text-sm text-center mt-8"> Do not have an account <a href="javascript:void(0);" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
            </div>
          </form>
        </div>
      </div>
